...
declare global {
  ...
  const resHosptAreaDepUserList: typeof import('./src/api/system/user')['resHosptAreaDepUserList']
  ...
  const updateHosptAreaInfo: typeof import('./src/api/system/user')['updateHosptAreaInfo']
  ...
  const useGetStorageAsync: typeof import('./src/hooks/web/useStorage')['useGetStorageAsync']
