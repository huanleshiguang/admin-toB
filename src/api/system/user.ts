 ...
 * @LastEditTime: 2023-07-18 14:03:11
...
// 更新院区信息
export const apiUpdateHosptAreaInfo = (data) => request.post({ url: API.UPDATE_HOSPT_AREA_INFO, data })

// 删除院区信息
export const apiDeleteHosptAreaInfo = (areaId) => request.post({ url: `${API.DELETE_HOSPT_AREA_INFO}?areaId=${areaId}` })
