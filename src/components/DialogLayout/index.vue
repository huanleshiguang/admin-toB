<template>
  ...
  >
    ...
    <template>
      <common-loading v-if="initLoading"></common-loading>
      <common-error v-if="initError" :error="initError as ErrorType"></common-error>
      <!-- 默认插槽 -->
...
import CommonLoading from '/@/components/common/common-loading.vue';
defineComponent({
  name: 'DialogLayout'
});
